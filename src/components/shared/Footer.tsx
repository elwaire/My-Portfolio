...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="bg-[#ffffff] text-black border-t border-gray-200">
            {/* CTA Section */}
            <div className="container mx-auto px-6 py-20 text-center">
                <p className="text-neutral-400 text-xs font-light uppercase tracking-widest mb-4">
                    Got a project in mind?
                </p>
                <h2 className="text-3xl md:text-3xl mb-8">Let's work together</h2>
                <a
            ...
            {/* Bottom Section */}
            <div className="container mx-auto px-6 py-8 font-light">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <button
                        ...
                        className="text-neutral-500 cursor-pointer hover:text-blue-500 text-sm transition-colors duration-300 
