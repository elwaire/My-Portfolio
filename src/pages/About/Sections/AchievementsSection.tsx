...
const AchievementsSection: React.FC<AchievementsSectionProps> = ({ achievements }) => (
    <motion.section
        ...
        className="space-y-6"
    >
        <h2 className="text-2xl font-medium uppercase text-gray-900">Achievements</h2>
        <div className="space-y-6">
            {achievements.map((achievement, index) => (
                <motion.div
                    ...
                    className="flex gap-6 py-4 rounded-lg items-start transition-colors"
                >
                    <div className="text-sm font-meidym text-gray-500 mt-0.5 min-w-[60px]">{achievement.year}</div>
